...
-- GENERATED by tools/sql/build_pending.py from 2026-09-15_ht29.sql, 2026-09-20_ht30.sql, 2026-09-22_ht31.sql. Never hand-edited: re-run the builder.
--
...
--
-- It is 3 migration(s), applied in the order they were written, each in its own transaction. If one
